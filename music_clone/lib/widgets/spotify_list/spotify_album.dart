    ...
    return FutureBuilder<List<Album>>(
      ...
      future: Future.wait([
        spotifyService.getAlbum(
            '03ZYR4zwCrkSsXTROnK2d0'), // Thay bằng ID album thật nếu muốn
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return SizedBox(
            height: 300, // Chiều cao của ListView
                ...
                return SizedBox(
                  ...
                  child: Card(
                    ...
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(8.0), // Độ cong của card
                    ),
                    child: Column(
                        ...
                        Expanded(
                          child: album.imageUrl != null
                              ? Image.network(
                                  ...
                                  fit: BoxFit.cover, // Ảnh vừa với container
